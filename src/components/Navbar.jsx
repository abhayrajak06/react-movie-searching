...
const Navbar = () => {
  return (
    <div className="main lg:flex md:flex flex-wrap justify-between items-center p-4 bg-[#40407a] shadow-md sticky top-0">
      ...
      <div className="right">
        <ul className="flex text-white space-x-4 justify-center">
          <li>Home</li>
          <li>About</li>
          <li>Contact</li>
          <li>Services</li>
